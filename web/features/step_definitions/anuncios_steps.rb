...
Dado("que acesso o formulário de cadastro de anúncios") do
  ...
  #expect(page).to have_css "#equipoForm" #isso é checkpoint para garantir que estou no lugar correto
end

Dado("que eu tenho o seguinte equipamento:") do |table|
  @anuncio = table.rows_hash #rows_hash método que pega uma tabela de chave valor e converte para objeto ruby
                             #@anuncio transforma a váriavel global para que possa ser usada em todo o script
